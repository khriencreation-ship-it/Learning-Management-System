...
export default function DeleteTutorModal({ isOpen, onClose, onSuccess, tutor }: DeleteTutorModalProps) {
    ...
    const handleDelete = async () => {
        ...
        if (confirmName !== tutor.name.toUpperCase()) {
            setError('Please type the tutor full name correctly in CAPITAL letters');
            return;
        }
        ...
        try {
            const res = await fetch(`/api/admin/users?id=${encodeURIComponent(tutor.id)}`, {
                method: 'DELETE',
            });
        ...
        <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-[2.5rem] w-full max-w-md p-8 shadow-2xl overflow-hidden">
                ...
                <div className="flex flex-col items-center text-center mt-4">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mb-2">Delete Tutor?</h2>
                    <p className="text-gray-500 text-sm mb-8 leading-relaxed">
                        This action is <span className="text-red-600 font-bold italic">permanent</span>. All data associated with <span className="text-gray-900 font-bold">{tutor.name}</span> will be removed from the system.
                    </p>
                    ...
                    <div className="w-full space-y-4 mb-8">
                        <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 text-left">
                            ...
                            <p className="text-xs text-gray-600 mb-3">
                                To confirm, please type <span className="font-mono font-bold text-gray-900">{tutor.name.toUpperCase()}</span> below:
                            </p>
                            <input
                                type="text"
                    ...
                    <div className="flex w-full gap-3">
                        ...
                        <button
                            disabled={loading || confirmName !== tutor.name.toUpperCase()}
