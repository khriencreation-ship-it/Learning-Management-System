...
export default function CreateCohortModal({ isOpen, onClose, onSuccess }: CreateCohortModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // 2. Create cohort (Upload handled by Media Library now)
            const res = await fetch('/api/admin/cohorts', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ name, batch, description, startDate, endDate, image: imageUrl }),
            });
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-3xl w-full max-w-md p-7 shadow-2xl scale-100 transition-transform max-h-[90vh] overflow-y-auto custom-scrollbar">
                ...
                <div className="mb-6">
                    ...
                    <p className="text-gray-500 mt-1 text-sm">Set up a new learning batch.</p>
                </div>
