                    ...
                    <>
                        ...
                        <header className="hidden md:flex sticky top-0 z-20 bg-white/80 backdrop-blur-md border-b border-gray-100 px-8 py-4 items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h1 className="text-sm font-black text-gray-900 uppercase tracking-widest">Student Dashboard</h1>
                                    <p className="text-[10px] text-gray-500 font-bold uppercase tracking-wider">LMS Learning Center</p>
                                </div>
                            </div>

                            <div className="flex items-center gap-6">
                                <div className="flex flex-col items-end">
                                    <span className="text-xs font-black text-gray-900">Student Panel</span>
                                    <span className="text-[10px] text-emerald-500 font-bold uppercase tracking-widest">Learning Active</span>
                                </div>
