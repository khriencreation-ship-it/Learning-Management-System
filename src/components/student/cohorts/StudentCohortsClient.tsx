...
export default function StudentCohortsClient() {
    ...
    useEffect(() => {
        const fetchCohorts = async () => {
            try {
                ...
                const res = await fetch('/api/student/cohorts', {
            ...
            <div className="space-y-10 max-w-6xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 pb-2">
                    <div className="space-y-1">
                        ...
                        <p className="text-gray-500 font-medium text-lg">View cohorts you are registered in.</p>
                    </div>
                </div>
                ...
                {filteredCohorts.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-20 bg-white rounded-3xl border border-gray-100 border-dashed text-center">
                        ...
                        <p className="text-gray-500 max-w-sm mb-8">
                            {cohorts.length === 0
                                ? "You are not registered in any cohorts yet."
